...
If use X (simple model): use line 1 and 4, comment on line 2 3 5 6 and run the code block again
If use X^2: use line 2 and 5, comment on line 1 3 4 6 and run the code block again
If use X^3: use line 3 and 6, comment on line 1 2 4 5 and run the code block again
